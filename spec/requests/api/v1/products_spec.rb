    ...
    describe "#index" do
      context 'category 1 product 1' do
        before do
          ...
          # call
          get "#{API_V1}/categories/#{my_category.id}/products"
        end
      ...
      context 'category 2 product 2' do
        before do
          ...
          # call
          get "#{API_V1}/categories/#{my_category2.id}/products"
        end
    ...
    describe "#show" do
      context 'with valid parameters' do
        before do
          ...
          # call
          get "#{API_V1}/categories/#{my_category.id}/products/#{prd1.id}", params: { id: prd1.id }
        end
  ...
  describe "#DELETE" do
    describe "destroy" do
      before do
        prd1.category_id = my_category.id
        prd1.save!
        delete "#{API_V1}/categories/#{my_category.id}/products/#{prd1.id}", params: { id: prd1.id }
      end
